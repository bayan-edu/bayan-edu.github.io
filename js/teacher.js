...
import { app, bar, head, toast, esc, AR, bubble, errBox, BUILD, scrollTop, scrollBottom } from './ui.js';
...
export async function openGrade(id){
  ...
  if(e1 || !a){ app.innerHTML = errBox(e1 || {message:'لم تُوجد المحاولة'}, 'فتح المحاولة')
